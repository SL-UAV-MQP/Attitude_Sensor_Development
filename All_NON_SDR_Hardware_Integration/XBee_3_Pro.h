...
#define XBEE_3
    ...
    //b0 = 0 = Only send if space is avalible for full message
    //b0 = 1 = Send regaurdless of buffer size remaining
    //b1 = 0 = Do not flush serial buffer if forced to send and buffer is not empty
    //b1 = 1 = flush serial buffer if forced and and buffer is not empty
    //b2 = 0 = CTSRTS Disabled
    //b2 = 1 = CTSRTS Enabled
#define XBEE_MAC_ADDR "0x0013A200420633C3"

enum SERIAL_FLAGS
{
        //Base Empty Flag upon which other flaggs are enabled or disabled
    FLAGS = 0x00,
        //b0 = 0 = Only send if space is avalible for full message
        //b0 = 1 = Send regaurdless of buffer size remaining
    O_FORCE = 0x01,
