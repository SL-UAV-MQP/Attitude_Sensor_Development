...
#define STARTING_HEIGHT_ABOVE_SEA_LEVEL_AT_GROUND 155

    //reference pressure IN BAR, set before flight from either sensor pressure reading or local weather station
